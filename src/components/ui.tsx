...
export const Icons = {
  ...
  print: svg(<><path d="M6.5 9V3.5h11V9" /><rect x="3.5" y="9" width="17" height="7.5" rx="2" /><path d="M6.5 14h11v6.5h-11z" /><path d="M17 12h1" /></>),
  mail: svg(<><rect x="2.5" y="4.5" width="19" height="15" rx="2.5" /><path d="m3.5 7 7.6 5.3a1.6 1.6 0 0 0 1.8 0L20.5 7" /></>),
  paperclip: svg(<><path d="M20 11.5 12.2 19.3a4.6 4.6 0 0 1-6.5-6.5l8.3-8.3a3 3 0 1 1 4.3 4.3l-8.3 8.3a1.5 1.5 0 0 1-2.1-2.1l7.6-7.6" /></>),
  sparkle: svg(<><path d="M12 3v4M12 17v4M3 12h4M17 12h4" /><path d="m6 6 2.5 2.5M15.5 15.5 18 18M18 6l-2.5 2.5M8.5 15.5 6 18" /></>),
  bank: svg(<><path d="M3 9.5 12 4l9 5.5" /><path d="M4.5 9.5v8M9.5 9.5v8M14.5 9.5v8M19.5 9.5v8" /><path d="M2.5 20.5h19" /></>),
  copy: svg(<><rect x="9" y="9" width="12" height="12" rx="2.5" /><path d="M6 15H4.5A1.5 1.5 0 0 1 3 13.5v-9A1.5 1.5 0 0 1 4.5 3h9A1.5 1.5 0 0 1 15 4.5V6" /></>),
  scale: svg(<><path d="M12 4.5v15" /><path d="M7 7.5h10" /><path d="m4 15 3-7 3 7a3 3 0 0 1-6 0Z" /><path d="m14 15 3-7 3 7a3 3 0 0 1-6 0Z" /></>),
  book: svg(<><path d="M4 19.5V4.8A2.3 2.3 0 0 1 6.3 2.5H20v17" /><path d="M20 19.5H6.3a2.3 2.3 0 0 0 0 4.6H20z" /><path d="M8.5 7h7M8.5 10.5h5" /></>),
  bell: svg(<><path d="M18 8.5a6 6 0 0 0-12 0c0 6-2.5 7.5-2.5 7.5h17S18 14.5 18 8.5" /><path d="M10.2 20a2 2 0 0 0 3.6 0" /></>),
  tasks: svg(<><path d="M9 5.5H6.5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-12a2 2 0 0 0-2-2H15" /><rect x="9" y="3" width="6" height="4" rx="1.2" /><path d="m8.5 13.5 2.5 2.5 4.5-5" /></>),
};

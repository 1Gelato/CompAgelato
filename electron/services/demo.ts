...
const seed: Seed = {
  ...
  products: [
    { sku: 'CUP-100', name: 'Coupelle carton 100 ml (x50)', category: 'Contenants', unit: 'carton', qtyOnHand: 48, minQty: 20, unitCost: 8.9, supplier: 'EmballagePro', aliases: ['Coupelle 100ml', 'Coupelles carton 100 ml'], archived: false },
    { sku: 'CON-STD', name: 'Cornet gaufré standard (x120)', category: 'Contenants', unit: 'carton', qtyOnHand: 26, minQty: 15, unitCost: 12.4, supplier: 'EmballagePro', aliases: ['Cornet gaufre standard'], archived: false },
    { sku: 'SPO-BOI', name: 'Cuillère bois 95 mm (x100)', category: 'Ustensiles', unit: 'carton', qtyOnHand: 12, minQty: 18, unitCost: 4.2, supplier: 'EcoTable', aliases: ['Cuillere bois 95mm'], archived: false },
    { sku: 'SAC-KR', name: 'Sachet kraft imprimé (x250)', category: 'Emballages', unit: 'carton', qtyOnHand: 9, minQty: 6, unitCost: 31, supplier: 'EmballagePro', aliases: [], archived: false },
    { sku: 'BAC-5L', name: 'Bac inox 5 L', category: 'Matériel', unit: 'pièce', qtyOnHand: 22, minQty: 8, unitCost: 23.5, supplier: 'FroidOuest', aliases: ['Bac inox 5L'], archived: false },
    { sku: 'SER-BLA', name: 'Serviette blanche 30x30 (x500)', category: 'Ustensiles', unit: 'carton', qtyOnHand: 4, minQty: 10, unitCost: 14.8, supplier: 'EcoTable', aliases: [], archived: false },
    { sku: 'GAN-VIN', name: 'Gants vinyle taille M (x100)', category: 'Hygiène', unit: 'boîte', qtyOnHand: 31, minQty: 12, unitCost: 6.5, supplier: 'HygiPro', aliases: [], archived: false },
    { sku: 'CO2-CAR', name: 'Carboglace 10 kg', category: 'Froid', unit: 'sac', qtyOnHand: 3, minQty: 4, unitCost: 42, supplier: 'FroidOuest', aliases: ['Carboglace'], archived: false },
  ],
};
